...
// 1. تحديث BusinessesPage.tsx بالترويسة المدمجة الأنيقة والخالية من أي إضافات
...
export const BusinessesPage: React.FC = () => {
  ...
  return (
    <div dir="rtl" className="max-w-6xl mx-auto px-3 sm:px-4 py-2 space-y-3 font-['Cairo',sans-serif] text-zinc-100">
      ...
      {/* رأس الصفحة الأنيق والبسيط المطابق للهوية ومكان زر الرجوع الصحيح */}
...
console.log('✅ تم تطبيق الترويسة الأنيقة المدمجة وحذف كافة المسميات والزيادات.');

...
import {
  ...
  Coffee, Store, ShieldCheck, Layers, X, TrendingUp
} from 'lucide-react';
...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  // 2. استخراج المنشآت: الأعلى تقييماً (Yelp Model)
  ...
  return (
    <div dir="rtl" className="space-y-5 pt-1 max-w-5xl mx-auto px-3 sm:px-4 font-['Cairo',sans-serif] text-white">
      ...
      {/* ======================================================== */}
      {/* 8️⃣ بوابة التوثيق الرسمي لأصحاب المنشآت */}
      {/* ======================================================== */}
      ...
      {/* ======================================================== */}
      {/* 9️⃣ نافذة استعراض كامل الـ 33 تصنيفاً الرسمية */}
      {/* ======================================================== */}
...
print("✅ تم بنجاح كتابة وإغلاق HomeView.tsx بالكامل 100%.")

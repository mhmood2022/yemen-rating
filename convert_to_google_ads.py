google_ad_component = '''import React, { useState, useEffect } from 'react';
...
with open("src/components/common/AdBanner.tsx", "w", encoding="utf-8") as f:
    f.write(google_ad_component)

print("✅ تم تحويل AdBanner.tsx بالكامل إلى نمط Google Ads (حواف مستقيمة + ارتفاع رشيق + شارة AdChoices + زر ✕).")

  ...
  return (
    <div dir="rtl" className="space-y-6 pb-12">
      <div className="flex items-center justify-between pb-4 border-b border-zinc-800">
        ...
        <button
          onClick={onBack}
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-zinc-900 border border-zinc-800 text-xs text-yellow-400 hover:text-yellow-300"
        >
      ...
      <div className="bg-zinc-900/60 border border-zinc-800 rounded-3xl p-6 flex flex-col sm:flex-row items-center gap-5">
        ...
        <div className="space-y-1 text-center sm:text-right flex-1">
          <div className="flex items-center justify-center sm:justify-start gap-2">
            ...
            <span className="text-[10px] bg-amber-400/10 text-yellow-400 border border-amber-400/30 px-2 py-0.5 rounded-full">عضو موثق</span>
          </div>
          <p className="text-xs text-zinc-400 flex items-center justify-center sm:justify-start gap-3">
            <span className="flex items-center gap-1"><Phone className="w-3 h-3 text-yellow-400" /> 777123456</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          <Heart className="w-6 h-6 text-yellow-400 group-hover:scale-110 transition-transform" />

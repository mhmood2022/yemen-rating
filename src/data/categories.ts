import {
  ...
  Utensils, ShoppingCart, Store, Building, ShoppingBag, Brush,
  Car, Bike, Shirt, Gem, Egg, Glasses, LucideIcon
} from 'lucide-react';
...
export const OFFICIAL_CATEGORIES: CategoryItem[] = [
  ...
  { id: '14', slug: 'barbers', name: 'الحلاقون', icon: Scissors, iconName: 'Scissors', isActive: true, order: 14 },
  { id: '15', slug: 'coiffure', name: 'الكوافير', icon: Sparkles, iconName: 'Sparkles', isActive: true, order: 15 },
  { id: '16', slug: 'steam-baths', name: 'الحمامات البخارية', icon: Bath, iconName: 'Bath', isActive: true, order: 16 },
  ...
  { id: '24', slug: 'cleaning-companies', name: 'شركات التنظيف', icon: Brush, iconName: 'Brush', isActive: true, order: 24 },
  { id: '25', slug: 'car-dealerships', name: 'معارض السيارات', icon: Car, iconName: 'Car', isActive: true, order: 25 },
  { id: '26', slug: 'motorcycle-dealerships', name: 'معارض الدراجات النارية', icon: Bike, iconName: 'Bike', isActive: true, order: 26 },
  { id: '27', slug: 'clothing-shoes', name: 'محلات الملابس والأحذية', icon: Shirt, iconName: 'Shirt', isActive: true, order: 27 },
  { id: '28', slug: 'gold-shops', name: 'محلات الذهب', icon: Gem, iconName: 'Gem', isActive: true, order: 28 },
  { id: '29', slug: 'poultry-farms', name: 'مزارع الدواجن', icon: Egg, iconName: 'Egg', isActive: true, order: 29 },
  { id: '30', slug: 'optics-audiology', name: 'البصريات والسمعيات', icon: Glasses, iconName: 'Glasses', isActive: true, order: 30 }
];
